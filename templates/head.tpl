...
<head profile="http://gmpg.org/xfn/1">
	...
	<link rel="alternate" type="application/rss+xml" title="RSS" href="rss.php/{$rss_id}.xml" />
...
<div id="throbber"><img src="img/throbber.gif" />Please wait while lylina updates...</div>-->
<div id="main">
<!--<div id="new">Get new items</div>-->
